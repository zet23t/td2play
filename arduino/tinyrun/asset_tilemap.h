...
namespace TilemapAsset {
	...
	namespace ID {
		const uint16_t el_01 = 1;
		const uint16_t el_02 = 2;
		const uint16_t el_03 = 3;
		const uint16_t el_04 = 4;
		const uint16_t el_05 = 5;
		const uint16_t el_06 = 6;
		const uint16_t skymap = 7;
	}
}
