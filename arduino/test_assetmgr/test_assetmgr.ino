...
void loop() {
    ...
    renderer.update(buffer, tilemap, x%tilemap.calcWidth()+48, 32,0,1,0);
    renderer.update(buffer, tilemap, x%tilemap.calcWidth()+48 - tilemap.calcWidth(), 32,0,1,0);
    buffer.drawRect(32, 32,8,8)->sprite(&tiles,(x/8%2)*8,32);
    renderer.update(buffer, tilemap, x%tilemap.calcWidth()+48, 32,1,3,0);
    renderer.update(buffer, tilemap, x%tilemap.calcWidth()+48 - tilemap.calcWidth(), 32,1,3,0);
